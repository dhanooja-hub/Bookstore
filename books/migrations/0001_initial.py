# Generated by Django 5.0.5 on 2024-05-21 15:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Basket_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cartitems', to='books.basket')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('basket_item_objects', models.ManyToManyField(to='books.basketitem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('is_active', models.BooleanField(default=True)),
                ('Category_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='books.category')),
                ('tag_object', models.ManyToManyField(to='books.tag')),
            ],
        ),
        migrations.AddField(
